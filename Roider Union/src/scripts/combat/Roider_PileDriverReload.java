 ...
 * Author: SafariJohn
 */
public class Roider_PileDriverReload implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
    private Roider_PileDriverSmoke smoke = new Roider_PileDriverSmoke();
