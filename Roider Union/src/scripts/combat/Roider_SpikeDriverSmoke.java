...
import static scripts.combat.Roider_PileDriverSmoke.PROHIBITED_REAR;
 ...
 * @author Nicke535
 */
public class Roider_SpikeDriverSmoke implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        ...
        PARTICLE_SPAWN_POINT_TURRET.put(EXHAUST_PUFF, new Vector2f(0f, -12f));
        PARTICLE_SPAWN_POINT_TURRET.put(EXHAUST, new Vector2f(0f, -12f));
    }
    ...
    static {
        ...
        PARTICLE_SPAWN_POINT_HARDPOINT.put(EXHAUST_PUFF, new Vector2f(0f, -16f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put(EXHAUST, new Vector2f(0f, -16f));
    }
    ...
    static {
        ...
        PARTICLE_TYPE.put(EXHAUST, "BRIGHT");
    }
