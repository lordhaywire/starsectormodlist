 ...
 */
public class Roider_APRHail extends BaseCommandPlugin {
...
//									  faction.getBaseUIColor());
		...
		dialog.getTextPanel().addPara("The " + factionName + " " + shipOrFleet + " is broadcasting an offer to retrofit ships.",
									  faction.getBaseUIColor());
