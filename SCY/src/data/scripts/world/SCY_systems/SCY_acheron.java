...
//        ProcgenUsedNames.notifyUsed("Acheron");
        ...
        PlanetAPI acheron_star = system.initStar(
                txt("stm_starA"), // unique id for this star 
                "SCY_companionStar", // id in planets.json
                550f,
                800); // radius (in pixels at default zoom)
        system.setLightColor(new Color(255, 215, 200)); // light color in entire system, affects all entities
        
//        system.getLocation().set(8000f, -19500f); //set the hyperspace location

        //set a fake hyperspace location due to the way proc gen avoid adding systems near handmade ones
        system.getLocation().set(6000f, -15000f); //set the hyperspace location

        SectorEntityToken acheron_nebula = Misc.addNebulaFromPNG("data/campaign/terrain/SCY_acheron.png",
				  0, 0, // center of nebula
				  system, // location to add to
				  "terrain", "nebula", // "nebula_blue", // texture to use, uses xxx_map for map
				  4, 4, StarAge.AVERAGE); // number of cells in texture
    
        SectorEntityToken barycenter = system.addCustomEntity(
                "SCY_barycenter",
                txt("stm_center"),
                "SCY_barycenter",
                null);
        ...
        //CLOUD RING        
        RingBandAPI accretion = (RingBandAPI) system.addRingBand(acheron_star, "misc", "SCY_ringsC", 1024f, 0, Color.WHITE, 512f, 1750, 44f);
        ...
        system.addRingBand(acheron_star, "misc", "SCY_ringsR", 1024f, 0, Color.WHITE, 1024f, 1300, 46f,Terrain.RING, txt("stm_ringA1"));
		...
		stationDerelict.setId("acheron_derelict");
		stationDerelict.setCircularOrbit(acheron_star, 360*(float)Math.random(), 900, 10f);
        ...
        */
        ...
        //2000
        PlanetAPI ach1 = system.addPlanet("ACH_a", acheron_star, txt("stm_planetA1"), "SCY_burntPlanet", 25, 80, 2000, 89);        
        //JUMP POINT
        ...
        //HULKS
        addDerelict(system, ach1, "lasher_CS", ShipRecoverySpecial.ShipCondition.BATTERED, 270f, (Math.random()<0.5));
        addDerelict(system, ach1, "kite_Standard", ShipRecoverySpecial.ShipCondition.AVERAGE, 300f, (Math.random()<0.5));
        addDerelict(system, ach1, "kite_Standard", ShipRecoverySpecial.ShipCondition.WRECKED, 350f, (Math.random()<0.5));
        addDerelict(system, ach1, "tarsus_d_Standard", ShipRecoverySpecial.ShipCondition.BATTERED, 375f, (Math.random()<0.5));
        addDerelict(system, ach1, "buffalo2_FS", ShipRecoverySpecial.ShipCondition.AVERAGE, 400f, (Math.random()<0.5));
        
        //2500
        PlanetAPI ach2 = system.addPlanet("ACH_b", acheron_star, txt("stm_planetA2"), "lava", 225, 150, 2750, 114f);
        
        //3250
        //ASTEROID BELT
        system.addAsteroidBelt(acheron_star, 250, 3750, 1536, 198, 262, Terrain.ASTEROID_BELT, txt("stm_ringA2"));
        system.addRingBand(acheron_star, "misc", "SCY_ringsD", 1024f, 0, Color.white, 1024f, 3500, 207f);
        system.addRingBand(acheron_star, "misc", "SCY_ringsD", 1024f, 0, Color.white, 1024f, 3600, 216f);
        system.addRingBand(acheron_star, "misc", "SCY_ringsD", 1024f, 0, Color.white, 1024f, 3700, 225f);
        system.addRingBand(acheron_star, "misc", "SCY_ringsD", 1024f, 0, Color.white, 1024f, 3800, 234f);
        system.addRingBand(acheron_star, "misc", "SCY_ringsD", 1024f, 0, Color.white, 1024f, 3900, 243f);
        system.addRingBand(acheron_star, "misc", "SCY_ringsD", 1024f, 0, Color.white, 1024f, 4000, 252f);

        system.addRingBand(acheron_star, "misc", "SCY_ringsR", 1024f, 0, Color.white, 1024f, 3600, 211f);
        system.addRingBand(acheron_star, "misc", "SCY_ringsR", 1024f, 0, Color.white, 1024f, 3700, 220f);
        system.addRingBand(acheron_star, "misc", "SCY_ringsR", 1024f, 0, Color.white, 1024f, 3800, 239f);
        system.addRingBand(acheron_star, "misc", "SCY_ringsR", 1024f, 0, Color.white, 1024f, 3900, 247f);
        //OLD RELAY
        SectorEntityToken relay = system.addCustomEntity("ACH_abandonned_relay", // unique id
        ...
        //4000
        PlanetAPI ach3 = system.addPlanet("ACH_c", acheron_star, txt("stm_planetA3"), "SCY_acid", -35, 100, 5000, 585);
        //FREEPORT
        SectorEntityToken SCY_amityFreeport = system.addCustomEntity(
                "SCY_amityFreeport",
                txt("stm_stationA3"),
                "SCY_amity_type",
                "independent");
...
//        //is Nexerelin present:
//        if(!Global.getSettings().getModManager().isModEnabled("exerelin")){
//            addMarketplace(
//                "independent",
//                SCY_prismFreeport,
//                null,
...
//        }
        ...
        PlanetAPI ach4 = system.addPlanet("ACH_d", acheron_star, txt("stm_planetA4"), "SCY_redRock", 360*(float)Math.random(), 120, 6500, 585);

        //8000
        //ASTEROIDS
        system.addAsteroidBelt(acheron_star, 350, 8000, 1024, 1300, 1330, Terrain.ASTEROID_BELT, txt("stm_ringA3"));
        PlanetAPI ach5 = system.addPlanet("ACH_e", acheron_star, txt("stm_planetA5"), "barren", 360*(float)Math.random(), 70, 8000, 1314);
        //PIRATE STATION
        SectorEntityToken SCY_piratePort = system.addCustomEntity(
                "SCY_piratePort",
                txt("stm_stationA5"),
                "SCY_pirate_type",
                "pirates");
...
//        );
        ...
        //trojans
		SectorEntityToken acheronL4 = system.addTerrain(Terrain.ASTEROID_FIELD, 
				new AsteroidFieldTerrainPlugin.AsteroidFieldParams(500f, 700f,	30,	40, 4f,	24f, 
				txt("stm_asteroidAL4"))); 
		
		SectorEntityToken acheronL5 = system.addTerrain(Terrain.ASTEROID_FIELD, 
				new AsteroidFieldTerrainPlugin.AsteroidFieldParams(500f, 700f,	30,	40, 4f,	24f, 
						txt("stm_asteroidAL5"))); 
    ...
    /////////////////////////////////     
        ...
        PlanetAPI star = system.addPlanet(
                "SCY_acheron",
                barycenter,
                txt("stm_starB"),
                "SCY_star",
        ...
        //600
        //ANTIMATTER REFINERY
        SectorEntityToken SCY_refinery = system.addCustomEntity(
                "SCY_refinery",
                txt("stm_stationBa"),
                "SCY_refinery_type",
                "SCY");
...
//        );
        ...
        //1750
        //ASTEROID BELT
        system.addAsteroidBelt(star, 150, 1750, 512, 101, 131,Terrain.ASTEROID_BELT, txt("stm_ringB1"));
        ...
        //ORE PROCESSING
        SectorEntityToken SCY_processing = system.addCustomEntity(
                "SCY_processing",
                txt("stm_stationBb"),
                "SCY_processing_type",
                "SCY");
...
//                true);
        ...
        //2500
        //ELYSEE
        PlanetAPI tar4 = system.addPlanet("TAR_elysee", star, txt("stm_planetB1"), "SCY_homePlanet", 30, 150, 2500, 328);        
        tar4.setInteractionImage("illustrations", "SCY_elysee");
        tar4.setCustomDescriptionId("SCY_homePlanet");        
        //HEPHAISTOS
        SectorEntityToken SCY_station = system.addCustomEntity(
                "SCY_hephaistosStation",
                txt("stm_stationB1"),
                "SCY_hephaistosStation_type",
                "SCY");
...
//        );
        ...
        //3500 
        PlanetAPI tar5 = system.addPlanet("TAR_sisyphus", star, txt("stm_planetB2"), "toxic", 360*(float)Math.random(), 75, 3500, 505);
            //moon
            PlanetAPI tar51 = system.addPlanet("TAR_boulder", tar5, txt("stm_planetB2a"), "barren", 360*(float)Math.random(), 30, 350, 8);

        //4000
        PlanetAPI tar7 = system.addPlanet("TAR_mine", star, txt("stm_planetB3"), "SCY_miningColony", 360*(float)Math.random(), 90, 4000, 707);        
        ...
        tar7.setCustomDescriptionId("SCY_miningColony");                
                ...
                SectorEntityToken SCY_outpost = system.addCustomEntity(
                        "SCY_overwatchStation",
                        txt("stm_stationB3"),
                        "SCY_overwatchStation_type",
                        "SCY");
...
//                        true);
        ...
        //6000        
        PlanetAPI tar8 = system.addPlanet("TAR_tantalus", star, txt("stm_planetB4"), "cryovolcanic", 360*(float)Math.random(), 80, 6000, 929);        
                //BIO CONDITIONING
                SectorEntityToken SCY_conditioning = system.addCustomEntity(
                        "SCY_conditioning",
                        txt("stm_stationB4"),
                        "SCY_conditioning_type",
                        "SCY");
...
//                        true);
        ...
        //7500
        PlanetAPI tar9 = system.addPlanet("TAR_ixion", star, txt("stm_planetB5"), "barren", 100, 60, 7500, 1299);
        PlanetAPI tar10 = system.addPlanet("TAR_tityos", star, txt("stm_planetB6"), "frozen", 280, 70, 7500, 1299);        
        //ASTEROID BELT
        system.addAsteroidBelt(star, 100, 7500, 720, 1225, 1375,Terrain.ASTEROID_BELT, txt("stm_ringC"));
        ...
        //YGGDRASILL WRECKAGE
        SectorEntityToken neutralStation = system.addCustomEntity(
        ...
        MarketAPI market = Global.getFactory().createMarket(txt("stm_stationB7"), neutralStation.getName(), 0);
            ...
            neutralStation.getMarket().getSubmarket(Submarkets.SUBMARKET_STORAGE).getCargo().addCommodity("SCY_intelChip", 1);
		...
		SectorEntityToken debrisWreckage = Misc.addDebrisField(system, params, StarSystemGenerator.random);
        ...
        OrbitAPI orbit2 = Global.getFactory().createCircularOrbit(star, (float)Math.random()*360, 8000, 1500);
    ...
    private void addMarketplace(
        ...
        globalEconomy.addMarket(newMarket,junk);
