...
/*		PersonAPI sfcyenniPerson = Global.getSector().getFaction("sindrian_diktat").createRandomPerson(FullName.Gender.FEMALE);
		...
		sfcyenniPerson.getStats().setSkillLevel(Skills.TARGET_ANALYSIS, 3);
		...
		sfcyenniPerson.getStats().setSkillLevel(Skills.HELMSMANSHIP, 3);
		sfcyenniPerson.getStats().setSkillLevel(Skills.DAMAGE_CONTROL, 3);
		sfcyenniPerson.getStats().setSkillLevel(Skills.ENERGY_WEAPON_MASTERY, 3);
		...
		sfcruniPerson.setPersonality(Personalities.AGGRESSIVE);
