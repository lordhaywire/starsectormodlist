...
public class PersonalFleetHoracioCaden extends PersonalFleetScript {
	...
	public CampaignFleetAPI spawnFleet() {
		...
		m.triggerCreateFleet(FleetSize.MAXIMUM, FleetQuality.VERY_HIGH, Factions.LIONS_GUARD, FleetTypes.PATROL_LARGE, loc);
		...
		fleet.getFlagship().setShipName("LGS Lion's Roar");
