...
public class SFCRespawningFleetTracker implements FleetEventListener, EveryFrameScript {
    ...
    private static final String MEMORY_KEY_IS_RETURNING_TO_DESPAWN = "$sfc_fleet_restocking";
    ...
    //private final String memKeyOnDefeat;
    ...
    public static void register(CampaignFleetAPI fleet, FleetParamsV3 originalSpawnParams){
        Global.getSector().addScript(new SFCRespawningFleetTracker(fleet, originalSpawnParams));
    }

    private SFCRespawningFleetTracker(CampaignFleetAPI fleet, FleetParamsV3 originalSpawnParams) {
        this.fleet = fleet;
        ...
        //this.memKeyOnDefeat = memKeyOnDefeat.startsWith("$") ? memKeyOnDefeat : "$" + memKeyOnDefeat;
    ...
    private void returnToPlanetAndDespawn(){
        ...
        SectorEntityToken where = target.getPrimaryEntity();

        fleet.clearAssignments();
        fleet.addAssignment(FleetAssignment.GO_TO_LOCATION, where, 1000f, "returning to " + where.getName());
        fleet.addAssignment(FleetAssignment.ORBIT_PASSIVE, where, 3f, "preparing to disband");
    ...
    private void returnToPlanetAndRecuperate(){
        ...
        fleet.addAssignment(FleetAssignment.ORBIT_PASSIVE, respawnMarket.getPrimaryEntity(), DAYS_UNTIL_FP_RECOVERY, "getting repaired");
    }
    ...
    public void reportFleetDespawnedToListener(CampaignFleetAPI fleet, CampaignEventListener.FleetDespawnReason reason, Object param) {
        ...
        //if (!defeated)
        overrideFleetBackupWithBlankCopy();
