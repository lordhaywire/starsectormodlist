...
public class FastTrig {
    ...
    private static double reduceSinAngle(double radians) {
        ...
        if (Math.abs(radians) > Math.PI) radians -= (Math.PI * 2.0); // put us in -PI to +PI space
        if (Math.abs(radians) > Math.PI / 2.0)
            radians = Math.PI - radians; // put us in -PI/2 to +PI/2 space
        return radians;
    }
    ...
    public static double sin(double radians) {
        ...
        if (Math.abs(radians) <= Math.PI / 4.0) return Math.sin(radians);
        else return Math.cos(Math.PI / 2.0 - radians);
    }
     ...
     * @since 1.0
     */
    public static double cos(double radians) { return sin(radians + Math.PI / 2.0); }
     ...
     * @since 2.3
     */
    public static double atan(double z) { return (0.97239411 + -0.19194795 * z * z) * z; }
