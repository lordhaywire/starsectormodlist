...
public final class EnergyWeaponTraining extends BaseWeaponTraining {
    ...
    public static class Level1 implements ShipSkillEffect {
                          ...
                          final float level)
        {
            ...
            if (skillIds.contains("ballistic_mastery")) return;
    ...
    public static class Level2 implements ShipSkillEffect {
        ...
        public String getEffectDescription(float level) { return ""; }
