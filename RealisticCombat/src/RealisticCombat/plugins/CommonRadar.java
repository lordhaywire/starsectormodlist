 ...
 * convenience methods to access {@link Radar} values or perform common
 * radar operations.
 * <p>
 * @author LazyWizard
...
public interface CommonRadar<T>
{
     ...
     * {@link CommonRadar#enableStencilTest()}, otherwise other RealisticCombat.renderers will
     ...
     * @since 2.2
     */
    boolean isPointOnRadar(Vector2f worldLoc, float padding);
     ...
     * @since 1.0
     */
    Vector2f getPointOnRadar(Vector2f worldLoc);
     ...
     * @since 2.0
     */
    float[] getRawPointOnRadar(Vector2f worldLoc);
    ...
    /**
     * Filters out all contacts that aren't in radar range.
     *
    ...
    List filterVisible(List<? extends T> contacts, int maxContacts);
}
