...
public class ConduitShroudStats extends BaseShipSystemScript {
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		stats.getFluxDissipation().modifyMult(id, FLUXDOWN);
...
//		return ship.getPhaseCloak();
	...
	public StatusData getStatusData(int index, State state, float effectLevel) {
			...
			float mult4 = FLUXDOWN * effectLevel;
			float bonusPercent5 = (int) (((mult4) * 100f) - 100f);
		...
		return new StatusData("flux dissipation reduced by" + (int) bonusPercent5 + "%", true);
		}
		return null;
	}
}
