...
import static data.scripts.Gen.DEenablefortressmode;
import static data.scripts.Gen.DEremovenondiktatfeatures;
import static data.scripts.Gen.DEenablelitemode;
import static data.scripts.Gen.DEdisablelobers;
...
public class DE_ModPlugin extends BaseModPlugin {
    ...
    private static void initFortressModeChanges() {
        ...
        // Umbra gets annexed during 2nd AI war
