...
public class acs_guardpostrail extends BaseEveryFrameCombatPlugin {
    ...
    private static final String acs_rorariiShipID = "acs_guardpostfrig_rail";
    private static final String acs_rorariiProjectileID = "acs_guardpostfrig_lrm";
