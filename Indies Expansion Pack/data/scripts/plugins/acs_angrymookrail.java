...
public class acs_angrymookrail extends BaseEveryFrameCombatPlugin {
    ...
    private static final String acs_angrymookShipID = "acs_angrymookfrig_variant";
    private static final String acs_angrymookProjectileID = "acs_angrymookrail_lrm";
    ...
    public void advance(float amount, List<InputEventAPI> events) {
        ...
        while (iter.hasNext()) {
            ...
            switch (projectile.getProjectileSpecId()) {
                case acs_angrymookProjectileID: {
                    ...
                    FleetMemberAPI missileMember = Global.getFactory().createFleetMember(FleetMemberType.SHIP, acs_angrymookShipID);
