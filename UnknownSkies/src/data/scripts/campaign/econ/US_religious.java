...
public class US_religious extends BaseHazardCondition implements MarketImmigrationModifier {
    ...
    public void apply(String id) {        
        market.getAccessibilityMod().modifyFlat(id, ACCESSIBILITY_BONUS/100, "Religious Landmark");
        market.getStability().modifyFlat(id, STABILITY_BONUS, "Religious Landmark");
