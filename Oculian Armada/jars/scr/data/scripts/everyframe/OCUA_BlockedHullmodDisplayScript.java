...
// Code originally by Tartiflette for Tiandong Heavy Industries, extended by Dark Revenant for the Knights Templar
public class OCUA_BlockedHullmodDisplayScript extends BaseEveryFrameCombatPlugin implements EveryFrameScript {

    private static final String NOTIFICATION_HULLMOD = "ocua_blockedhullmod";
