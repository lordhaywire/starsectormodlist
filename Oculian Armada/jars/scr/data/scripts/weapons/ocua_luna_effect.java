 ...
 */
public class ocua_luna_effect implements OnFireEffectPlugin, OnHitEffectPlugin, EveryFrameWeaponEffectPlugin {

	protected CombatEntityAPI chargeGlowEntity;
	protected ocua_luna_chargeglow chargeGlowPlugin;
	public float maxDur;
	...
	public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
		...
		if (charging && chargeGlowEntity == null) {
			chargeGlowPlugin = new ocua_luna_chargeglow(weapon);
	...
	public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
		if (chargeGlowPlugin != null) {
			...
			missile.setMineExplosionRange(ocua_luna_chargeglow.MAX_ARC_RANGE + 50f);
