package data.missions.ocua_mi_test;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Mikanate Test Fleet");
		...
		api.addToFleet(FleetSide.PLAYER, "ocua_chimly_mi_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "ocua_gretly_mi_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "ocua_prily_mi_Standard", FleetMemberType.SHIP, false);
		
		api.addToFleet(FleetSide.PLAYER, "ocua_chimis_mi_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "ocua_lemphis_Standard", FleetMemberType.SHIP, false);
		
		api.addToFleet(FleetSide.PLAYER, "ocua_chimex_mi_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "ocua_basilix_mi_Standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "ocua_evalyx_Assault", FleetMemberType.SHIP, false);
		
		api.addToFleet(FleetSide.PLAYER, "ocua_nadia_mi_Assault", FleetMemberType.SHIP, true);
